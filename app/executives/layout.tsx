...
import { getAvailableYears, isStudentId } from "@/app/executives/util";
...
export default function ExecutivesLayout({
  ...
  // Check if current parameter is student ID to hide tabs
  const isViewingStudentProfile = currentYear && isStudentId(currentYear);
        ...
        <div className="container">
          ...
          <p className="text-muted-foreground max-w-[700px] mt-2">
            {isViewingStudentProfile 
              ? "Executive Profile - Dedicated members who have contributed to the Green University Computer Club"
